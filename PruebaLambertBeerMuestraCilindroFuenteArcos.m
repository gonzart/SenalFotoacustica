...
ZDisc=0.045;
tic;
[ t1,P1 ] = CalcPresSensDiscXYv1DAFuenteCilindroLBMat(ROl,NpS,NpF,distCC,RF,Alpha,ZDisc,LongCil,RebZ,deltat,tau,c);
tC1=toc;
filename = 'Pt1.mat';
save(filename,'t1','P1')
...
ZDisc=0.04;
tic;
[ t2,P2 ] = CalcPresSensDiscXYv1DAFuenteCilindroLBMat(ROl,NpS,NpF,distCC,RF,Alpha,ZDisc,LongCil,RebZ,deltat,tau,c);
tC2=toc;
filename = 'Pt2.mat';
save(filename,'t2','P2')
clear t2 P2
